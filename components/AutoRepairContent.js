...
<section className="ind-hero">
  ...
  <div className="wrap ind-hero-in">
    <div>
      ...
      <p className="sub">Built for Dubai and the UAE. You are under a car while the phone rings off the hook. NextReply answers every customer on WhatsApp, looks at the photo or listens to the problem, gives an estimate, and books the job into your calendar, even when the shop is closed.</p>
