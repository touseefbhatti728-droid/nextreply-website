...
<section className="ind-hero">
  ...
  <div className="wrap ind-hero-in">
    <div>
      ...
      <p className="sub">Built for Dubai and the UAE. Worried pet owners message at all hours. NextReply answers every owner on WhatsApp, understands the photos and symptoms they describe, flags urgent cases, and books appointments into your calendar, even after the clinic has closed.</p>
